...
const WINDOWS_INSTALLER_URL =
  "https://github.com/WgeorgeAssistantIA/InOneShot/releases/latest/download/InOneShot-Setup-2.0.0.exe";
const LINUX_URL =
  "https://github.com/WgeorgeAssistantIA/InOneShot/releases/latest/download/InOneShot-x86_64.AppImage";
const LINUX_TAR_URL =
  "https://github.com/WgeorgeAssistantIA/InOneShot/releases/latest/download/InOneShot_2.0.0_linux_x86_64.tar.gz";
...
export const t = {
  ...
  fr: {
    ...
    hero: {
      title:
        "Vos données clients sont trop sensibles pour le Cloud. Générez vos documents PDF en masse, 100% hors-ligne.",
      subtitle:
      ...
      badges: [
        ...
        "Idéal pour données RGPD/Sensibles",
      ],
      floating: { topLeft: "QR code & signature", bottomRight: "100% local — RGPD" },
      window: {
        title: "InOneShot",
        from: "Excel RH / Clients",
        to: "Attestations PDF",
        counter: "PDF",
        zip: "documents_generes.zip",
      },
    },
    video: {
    ...
    pain: {
      title: "Le publipostage de données sensibles vous bloque ?",
      text: "Les outils en ligne obligent à envoyer les données confidentielles de vos clients ou employés sur le web (illégal ou risqué). InOneShot fait le travail répétitif 100% en local sur votre machine.",
      solutionTitle: "Idéal pour les professions exigeantes :",
      steps: [
        "⚖️ Cabinets Juridiques & Notaires : Générez des actes et contrats sans enfreindre le secret professionnel.",
        "🏢 Ressources Humaines : Éditez vos fiches de paie et attestations avec une totale conformité RGPD.",
        "💼 Indépendants & PME : Factures et devis en un seul tir, sans abonnement mensuel.",
      ],
    },
    how: {
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 text-sm text-muted-foreground md:flex">
            ...
            <Link to="/publipostage-notaires" className="transition-colors hover:text-foreground">
              Notaires & Avocats
            </Link>
            <Link to="/attestations-rh" className="transition-colors hover:text-foreground">
              RH
            </Link>
