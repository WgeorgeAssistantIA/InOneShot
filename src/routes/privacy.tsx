...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Politique de confidentialité — InOneShot" },
      {
        name: "description",
        content:
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Le site inoneshot.fr et le logiciel InOneShot sont édités par William GEORGE, entrepreneur individuel exerçant sous le nom commercial « InOneShot » (SIRET : 518 251 897 00048 — adresse : 18 rue de l'Oiseau Blanc, 42155 Saint-Léger-sur-Roanne), ci-après « nous » ou « InOneShot ».",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "p",
            text: "Si vous achetez ou installez InOneShot via le Microsoft Store, la transaction et les données associées sont gérées par Microsoft, conformément à sa propre politique de confidentialité.",
          },
        ],
      },
      {
        h: "4. Le site inoneshot.fr",
        blocks: [
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "InOneShot n'est pas destiné aux personnes de moins de 15 ans et nous ne collectons pas sciemment de données les concernant.",
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "p",
            text: "The inoneshot.fr website and the InOneShot software are published by William GEORGE, a sole trader operating under the commercial name “InOneShot” (business registration (SIRET): 518 251 897 00048 — address: 18 rue de l'Oiseau Blanc, 42155 Saint-Léger-sur-Roanne, France), referred to below as “we” or “InOneShot”.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "p",
            text: "If you purchase or install InOneShot through the Microsoft Store, the transaction and associated data are handled by Microsoft, in accordance with its own privacy policy.",
          },
        ],
      },
      {
        h: "4. The inoneshot.fr website",
        blocks: [
          {
            type: "p",
          ...
          {
            type: "p",
            text: "If you choose to give us your email address through the newsletter sign-up form, it is stored with our email provider Resend (Plus Five Five, Inc., USA) and used only to inform you about InOneShot news and updates. It will never be sold or shared with third parties, and you can unsubscribe at any time via the link in each email or by contacting us.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "InOneShot is not intended for individuals under the age of 15, and we do not knowingly collect data about them.",
          },
        ],
      },
      {
