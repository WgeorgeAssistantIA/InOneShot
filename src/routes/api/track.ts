...
// Endpoint REST public (même pattern que sur VoxCut) : appelé par l'app
// desktop InOneShot (Python/urllib) pour savoir si le paywall in-app est vu
// et cliqué, avant même que l'utilisateur n'arrive sur le site. Anonyme :
// pas d'email, juste un client_id local aléatoire généré par l'app.
...
const GA4_MEASUREMENT_ID = "G-QC9FZM41ZC";
